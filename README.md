...
Learnova is an LMS SaaS app from scratch featuring user authentication, subscriptions, and payments using Next.js, Supabase, and Stripe! 

It is a real-time teaching platform integrated with Vapi, an AI vocal agent, to deliver seamless, interactive learning sessions.
...
```bash
git clone https://github.com/prachit082/SaaS-LMS.git
cd SaaS-LMS
```
...
Replace the placeholder values with your actual Clerk, Vapi, Supabase, and Sentry credentials. You can obtain these credentials by signing up on: [Clerk](https://jsm.dev/converso-clerk), [Vapi](https://jsm.dev/converso-vapi), [Supabase](https://supabase.com/dashboard), [Sentry](https://jsm.dev/converso-sentry) .
